...
import { parseSessionLog } from '@njydsz/ydb-llm-replay'
import type { SessionEvent, SessionId } from '@njydsz/ydb-session'
import type {} from '@njydsz/ydb-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@njydsz/ydb-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@njydsz/ydb-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@njydsz/ydb-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@njydsz/ydb-skill-filesystem"}\n',
