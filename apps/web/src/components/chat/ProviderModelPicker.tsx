...
const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "remi-code:cursor-favourite-models:v1",
  kilo: "remi-code:kilo-favourite-models:v1",
  opencode: "remi-code:opencode-favourite-models:v1",
  pi: "remi-code:pi-favourite-models:v1",
} as const;
