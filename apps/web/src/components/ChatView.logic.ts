...
export const LAST_INVOKED_SCRIPT_BY_PROJECT_KEY = "remi-code:last-invoked-script-by-project";
export const DISMISSED_PROVIDER_HEALTH_BANNERS_KEY = "remi-code:dismissed-provider-health-banners";
