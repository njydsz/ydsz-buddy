...
const zh: Messages = {
  ...
  settings: {
    ...
    nav: {
      ...
      providers: {
        label: "提供,
        description: "选择可见的提供方、查CLI 安装状态并更新提供方工具,
      },
      advanced: {
        label: "高级",
    ...
    worktrees: {
      ...
      deleteRemovesFromDisk: "这将从磁盘上移除Git 工作树,
      deletedTitle: "工作树已删除",
      deletedDescriptionWithArchived: (name, count) =>
    ...
    providers: {
      ...
      tools: {
        ...
        homePathDescription: "可选的自定Codex 主目录与配置目录,
        agentDirLabel: "Pi 代理目录",
        agentDirDescription: "可选的自定Pi 代理目录，用于鉴权、模型、技能与命令,
        ...
        binaryPathDescription: (command) => `留空将使PATH 中的 \`${command}\`。`,
