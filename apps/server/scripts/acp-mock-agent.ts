...
const requestLogPath = process.env.REMI_CODE_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.REMI_CODE_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.REMI_CODE_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.REMI_CODE_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitReasoningThenToolCall = process.env.REMI_CODE_ACP_EMIT_REASONING_THEN_TOOL_CALL === "1";
const emitGenericToolPlaceholders = process.env.REMI_CODE_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitAskQuestion = process.env.REMI_CODE_ACP_EMIT_ASK_QUESTION === "1";
const failSetConfigOption = process.env.REMI_CODE_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.REMI_CODE_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.REMI_CODE_ACP_PROMPT_RESPONSE_TEXT;
