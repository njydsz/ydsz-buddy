 ...
 * Enable with: REMI_CODE_CURSOR_ACP_PROBE=1 bun run test --filter CursorAcpCliProbe
 */
...
describe.runIf(process.env.REMI_CODE_CURSOR_ACP_PROBE === "1")("Cursor ACP CLI probe", () => {
    ...
    Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "remi-code-probe", version: "0.0.0" },
