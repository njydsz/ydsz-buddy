...
const GROK_ACP_DEBUG_ENV = "REMI_CODE_GROK_ACP_DEBUG";
...
const GROK_PLAN_MODE_PROMPT_PREFIX = [
  "Remi Code Grok plan mode is active.",
...
// Grok may reuse ACP item ids across resumed history; Remi Code runtime ids must stay turn-local.
      ...
      withThreadLock(
        ...
        Effect.gen(function* () {
          ...
          const acp = yield* makeGrokAcpRuntime({
            ...
            clientInfo: { name: "Remi Code", version: "0.0.0" },
            ...acpRuntimeLoggers,
          }).pipe(
