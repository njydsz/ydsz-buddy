...
import { buildClaudeSubagentPrompt } from "@remi-code/shared/agentMentions";
import {
  Cause,
  DateTime,
  Deferred,
...
const EMBEDDED_CLAUDE_SYSTEM_PROMPT_APPEND = [
  "You are running inside Remi Code, a coding app that embeds the Claude Agent SDK.",
...
function makeClaudeAdapter(options?: ClaudeAdapterLiveOptions) {
  return Effect.gen(function* () {
    ...
    // Native command discovery cache â€?avoids spawning a process per query.
