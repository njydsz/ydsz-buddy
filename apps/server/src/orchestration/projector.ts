import type { OrchestrationEvent, OrchestrationReadModel, ThreadId } from "@remi-code/contracts";
import {
  ...
  switch (event.type) {
    ...
    case "thread.turn-diff-completed":
      return Effect.gen(function* () {
        ...
        // the assistant message is finalized â€?they must not erase a real id
