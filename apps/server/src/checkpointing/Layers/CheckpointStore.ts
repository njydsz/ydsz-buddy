...
import { CheckpointRef } from "@remi-code/contracts";
        ...
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Remi Code",
              GIT_AUTHOR_EMAIL: "remi-code@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Remi Code",
              GIT_COMMITTER_EMAIL: "remi-code@users.noreply.github.com",
            };
