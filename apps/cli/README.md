...
Bundles named in `dsh.profile.bundles` resolve from the dsh installation first (`@njydsz/ydb-base`, `@njydsz/ydb-web-app`, `@njydsz/ydb-headless`), then from the profile's own `node_modules`, where pnpm installs out-of-tree plugins.
