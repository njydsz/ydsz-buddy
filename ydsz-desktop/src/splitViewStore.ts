/**
 * @file 分屏视图状态管理模块
 * @description 管理分屏聊天的面板树结构（深度限制为 2，最多支持 2x2 网格）。
 *              提供面板/分割类型、树形选择器和基于 ID 的变更操作。
 */

import { type ProjectId, type ThreadId, type TurnId } from "@ydsz-buddy/contracts";
...
// Keep the v1 suffix stable while using the ydsz-buddy namespace.
const SPLIT_VIEW_STORAGE_KEY = "ydsz-buddy:split-view-state:v1";
