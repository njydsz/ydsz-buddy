...
export default function GitActionsControl({
  ...
  runGitActionWithToastRef.current = async ({
      action,
      commitMessage,
  ...
  const runGitActionWithToast = (...args: Parameters<NonNullable<typeof runGitActionWithToastRef.current>>) =>
    runGitActionWithToastRef.current(...args);
