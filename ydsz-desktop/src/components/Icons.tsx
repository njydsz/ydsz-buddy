...
// ============================================================================
// 国内 6 家 Provider 图标（OpenAI 兼容）
// ============================================================================

/** 智谱 BigModel (GLM) 图标 */
export const GlmIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 4h7v7H4V4Zm8.5 0h7v7h-7V4ZM21 4h7v7h-7V4ZM4 12.5h7v7H4v-7Zm8.5 0h7v7h-7v-7Zm8.5 0h7v7h-7v-7ZM4 21h7v7H4v-7Zm8.5 0h7v7h-7v-7Zm8.5 0h7v7h-7v-7Z" />
  </svg>
);
...
export const DeepSeekIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M26.5 14.5c0-3.6-2.4-6.5-5.4-6.5-1.2 0-2.3.5-3.2 1.4-1.2-1.7-3-2.7-4.9-2.7-3 0-5.5 2.4-5.5 5.4 0 .3 0 .6.1.9-1.6.7-2.6 2.3-2.6 4 0 2.5 2 4.5 4.5 4.5h16c2.5 0 4.5-2 4.5-4.5 0-1.2-.5-2.3-1.4-3.1.6-.9.9-1.9.9-3v-.4Z" />
...
/** Moonshot Kimi 图标（月亮） */
export const MoonshotIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.5 4.5C16.7 4.5 12 9.2 12 15s4.7 10.5 10.5 10.5c.8 0 1.5-.1 2.2-.2C19.3 24.1 16 19.9 16 15s3.3-9.1 8.7-10.3c-.7-.1-1.4-.2-2.2-.2Z" />
    <circle cx="9" cy="9" r="1" />
    <circle cx="6" cy="14" r="0.7" />
    <circle cx="11" cy="22" r="0.8" />
  </svg>
);

/** 阿里通义千问 Qwen 图标（"通"字抽象） */
export const QwenIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M6 6h20v3H6V6Zm0 6h20v3H6v-3Zm0 6h20v3H6v-3Zm0 6h14v3H6v-3Z" />
    <circle cx="24" cy="25" r="2" fill="currentColor" />
  </svg>
);

/** 小米 MiMo 图标 */
export const MimoIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="24" height="24" rx="4" fill="currentColor" />
    <path d="M11 10h10v3h-3.5v9h-3v-9H11v-3Z" fill="#fff" />
  </svg>
);

/** MiniMax 图标（公司 logo 风格） */
export const MiniMaxIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 16c0-6.6 5.4-12 12-12s12 5.4 12 12-5.4 12-12 12S4 22.6 4 16Zm5 0c0 3.9 3.1 7 7 7s7-3.1 7-7-3.1-7-7-7-7 3.1-7 7Z" />
    <circle cx="16" cy="16" r="3" fill="currentColor" />
  </svg>
);

/** 字节跳动 豆包 图标 */
export const DoubaoIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="24" height="24" rx="4" fill="currentColor" />
    <text x="16" y="22" textAnchor="middle" fontSize="14" fontWeight="700" fill="#fff" fontFamily="system-ui, sans-serif">豆</text>
  </svg>
);

/** 百度 文心一言 图标 */
export const ErnieIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="24" height="24" rx="4" fill="currentColor" />
    <text x="16" y="22" textAnchor="middle" fontSize="14" fontWeight="700" fill="#fff" fontFamily="system-ui, sans-serif">文</text>
  </svg>
);

/** 腾讯混元 图标 */
export const HunyuanIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="24" height="24" rx="4" fill="currentColor" />
    <text x="16" y="22" textAnchor="middle" fontSize="14" fontWeight="700" fill="#fff" fontFamily="system-ui, sans-serif">元</text>
  </svg>
);
