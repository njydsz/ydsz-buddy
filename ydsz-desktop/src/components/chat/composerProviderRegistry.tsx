...
const composerProviderRegistry: Record<ProviderKind, ProviderRegistryEntry> = {
  ...
  // 国内 6 家 OpenAI 兼容 Provider：当前为 HTTP 透传，复用通用 trait 渲染
  glm: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("glm", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("glm", input),
  },
  deepseek: {
    getState: (input) => getProviderStateFromCapabilities(input),
  ...
  moonshot: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("moonshot", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("moonshot", input),
  },
  qwen: {
    getState: (input) => getProviderStateFromCapabilities(input),
  ...
  mimo: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("mimo", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("mimo", input),
  },
  MiniMax: {
    getState: (input) => getProviderStateFromCapabilities(input),
  ...
  // 新增 3 家国内 OpenAI 兼容 Provider:同上,复用通用 trait 渲染
  doubao: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("doubao", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("doubao", input),
  },
  ernie: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("ernie", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("ernie", input),
  },
  hunyuan: {
    getState: (input) => getProviderStateFromCapabilities(input),
    renderTraitsMenuContent: (input) => renderTraitsMenuContentForProvider("hunyuan", input),
    renderTraitsPicker: (input) => renderTraitsPickerForProvider("hunyuan", input),
  },
};
