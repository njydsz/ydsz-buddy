...
import { isTemporaryWorktreeBranch, resolveUniqueYdszBuddyBranchName } from "~/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueYdszBuddyBranchName(existingBranchNames, preferredBranch);
}
