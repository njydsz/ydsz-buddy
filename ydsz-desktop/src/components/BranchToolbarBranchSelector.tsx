            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                addBranchRecoveryToast({
                  ...
                  description:
                    "ydsz-buddy switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",
...
export function BranchToolbarBranchSelector({
  ...
  const [resolvedActiveBranch, setOptimisticBranch] = useState<string | null>(canonicalActiveBranch);
  ...
  const runBranchAction = async (action: () => Promise<void>) => {
    startBranchActionTransition(() => {
      // Intentionally fire-and-forget to satisfy TransitionFunction.
      void (async () => {
