...
export function providerUsageLabel(provider: ProviderKind | null | undefined): string {
  ...
  // 国内 Coding Plan 4 家：与 CodingPlanProvider.display_name 对齐
  if (provider === "glm") return "GLM Coding Plan usage";
  if (provider === "deepseek") return "DeepSeek Coding Plan usage";
  if (provider === "moonshot") return "Moonshot Coding Plan usage";
  if (provider === "qwen") return "Qwen Coding Plan usage";
  return "Usage";
}
