 ...
 * @file 执行环境契约模块
 *
 * 本模块定义了 ydsz 工作区中"执行环境"（Execution Environment）相关的 Schema，
...
export const ExecutionEnvironmentPlatformOs = Schema.Literal(
  "darwin",
  "linux",
  "windows",
  "unknown",
...
export const ExecutionEnvironmentPlatformArch = Schema.Literal("arm64", "x64", "other");
...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  repositoryIdentity: Schema.optional(Schema.Boolean).pipe(Schema.withDecodingDefault(() => false)),
});
