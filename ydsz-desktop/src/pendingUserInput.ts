/**
 * @file 待处理用户输入模块
 * @description 归一化待处理用户输入提示的草稿答案和进度。
 *              导出供 ChatView/composer 面板使用的草稿答案辅助函数和进度派生。
 */

import type { ProviderUserInputAnswers, UserInputQuestion } from "@ydsz-buddy/contracts";
