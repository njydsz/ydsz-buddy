/**
 * @file 线程终端状态管理模块
 * @description 基于 threadId 的 Zustand store，管理终端 UI 状态，包括终端布局、
 *              终端组、活跃终端、标签页等。提供持久化支持，确保用户界面状态跨会话保持。
 *
 * 终端转换辅助函数故意设为私有，以保持公共 API 限于 store actions/selectors。
 */

import { type TerminalActivityState, type TerminalCliKind } from "@njydsz/shared/terminalThreads";
...
const TERMINAL_STATE_STORAGE_KEY = "ydsz-buddy:terminal-state:v1";
