/**
 * @file 聊天布局路由模块
 * @description 聊天区域的共享布局路由，包含侧边栏、线程维护通知和全局快捷键处理。
 *   包含以下核心功能：
 *   1. 可折叠侧边栏（线程列表、项目管理）
 *   2. 线程保留维护通知（清理进度、成功/失败提示）
 *   3. 全局快捷键处理（新建对话、新建终端、新建特定 Provider 对话等）
 *   4. 菜单栏动作处理（切换侧边栏、打开设置）
 * @layer 路由层
 * @depends Sidebar, ShortcutsDialog, ThreadRetentionMaintenance, useHandleNewThread
 */
