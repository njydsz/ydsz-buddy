import type { ContextMenuItem } from "@ydsz-buddy/contracts";
...
export function showContextMenuFallback<T extends string>(
  ...
  return new Promise<T | null>((resolve) => {
    ...
    (menu.style as CSSStyleDeclaration & Record<"webkitBackdropFilter", string>).webkitBackdropFilter = "blur(24px)";
