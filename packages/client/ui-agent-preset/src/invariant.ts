/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-agent-preset`.
 * @module @njydsz/ydb-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-agent-preset'
