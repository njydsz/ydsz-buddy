...
import * as UiSlots from '@njydsz/ydb-client-ui-slots'
import * as WebReact from '@njydsz/ydb-client-web-react'
import * as UiPrimitives from '@njydsz/ydb-client-ui-primitives'
import * as UiAttachment from '@njydsz/ydb-client-ui-attachment'
import * as SchemaForm from '@njydsz/ydb-client-schema-form'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@njydsz/ydb-client-ui-slots': UiSlots,
    '@njydsz/ydb-client-web-react': WebReact,
    '@njydsz/ydb-client-ui-primitives': UiPrimitives,
    '@njydsz/ydb-client-ui-attachment': UiAttachment,
    '@njydsz/ydb-client-schema-form': SchemaForm,
