/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-subagent`.
 * @module @njydsz/ydb-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-subagent'
