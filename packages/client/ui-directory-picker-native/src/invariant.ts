/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-directory-picker-native`.
 * @module @njydsz/ydb-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-directory-picker-native'
