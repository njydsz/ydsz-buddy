/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-directory-picker-browse`.
 * @module @njydsz/ydb-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-directory-picker-browse'
