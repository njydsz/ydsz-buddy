/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-skill`.
 * @module @njydsz/ydb-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-skill'
