 ...
 * atoms' label props (`@njydsz/ydb-client-ui-attachment` reads no
...
} from '@njydsz/ydb-client-ui-attachment'
import type { ImageAttachmentLimits } from '@njydsz/ydb-attachment'
