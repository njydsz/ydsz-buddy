...
import { AttachmentRail, DropOverlay, ImageLightbox } from '@njydsz/ydb-client-ui-attachment'
import type { AttachmentRailItem } from '@njydsz/ydb-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@njydsz/ydb-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@njydsz/ydb-goal/client'
...
import type { Translate } from '@njydsz/ydb-client-ui-slots'
