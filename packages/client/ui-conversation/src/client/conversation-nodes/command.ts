...
import { isReplacementSurfaceEvent } from '@njydsz/ydb-client-runtime/client'
import type { CompactionCheckpointSource } from '@njydsz/ydb-compaction/checkpoint'
import type {} from '@njydsz/ydb-compaction/types'
import type {} from '@njydsz/ydb-commands/types'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@njydsz/ydb-client-ui-conversation/client' {
