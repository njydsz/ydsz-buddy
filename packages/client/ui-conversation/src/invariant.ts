/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-conversation`.
 * @module @njydsz/ydb-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-conversation'
