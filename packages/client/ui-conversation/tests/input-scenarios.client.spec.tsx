...
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@njydsz/ydb-client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from '@njydsz/ydb-client-runtime/client'
