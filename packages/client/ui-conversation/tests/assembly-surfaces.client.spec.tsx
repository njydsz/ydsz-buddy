...
import type { ISession, SessionId } from '@njydsz/ydb-client-runtime/client'
...
import { apply, inject, type EmptyWorkspaceOwnerProps } from '@njydsz/ydb-client-ui-conversation/client'
