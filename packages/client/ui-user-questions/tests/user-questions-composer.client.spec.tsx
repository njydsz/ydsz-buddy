...
import { PendingWait } from '@njydsz/ydb-client-runtime/client'
import type { RpcReceipt } from '@njydsz/ydb-api-remotes/client'
...
import { en as commonEn } from '@njydsz/ydb-client-locale/src/locales/en.ts'
