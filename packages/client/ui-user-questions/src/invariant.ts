/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-user-questions`.
 * @module @njydsz/ydb-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-user-questions'
