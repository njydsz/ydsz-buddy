...
import type { GoalSnapshot } from '@njydsz/ydb-goal/client'
import {
...
import type { PropsLocale } from '@njydsz/ydb-client-ui-slots'
...
export type GoalDockProps = import('@njydsz/ydb-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
