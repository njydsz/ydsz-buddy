...
import { SlotRegistry, type SessionId } from '@njydsz/ydb-client-runtime/client'
import { ConversationEventRegistry } from '@njydsz/ydb-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@njydsz/ydb-goal/client'
