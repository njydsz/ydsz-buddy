...
import { ConversationNodeAssembler } from '@njydsz/ydb-client-runtime/client'
...
import type { SessionEvent } from '@njydsz/ydb-session/types'
import { commandDefinition } from '@njydsz/ydb-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@njydsz/ydb-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
