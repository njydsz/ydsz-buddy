...
import { apply as nodeApply } from '@njydsz/ydb-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@njydsz/ydb-client-locale/client'
import * as LocaleInvariant from '@njydsz/ydb-client-locale/invariant'
