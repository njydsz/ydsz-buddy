/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-settings-plugins`.
 * @module @njydsz/ydb-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-settings-plugins'
