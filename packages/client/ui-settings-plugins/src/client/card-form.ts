...
import type { SettingsScope, SettingsScopeSnapshot } from '@njydsz/ydb-client-runtime/client'
import { createSnapshotStore, type SnapshotStore } from '@njydsz/ydb-client-runtime/client'
