/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-commands`.
 * @module @njydsz/ydb-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-commands'
