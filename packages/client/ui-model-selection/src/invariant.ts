/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-model-selection`.
 * @module @njydsz/ydb-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-model-selection'
