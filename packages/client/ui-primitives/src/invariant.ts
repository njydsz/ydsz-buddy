/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-primitives`.
 * @module @njydsz/ydb-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-primitives'
