/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-attachment`.
 * @module @njydsz/ydb-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-attachment'
