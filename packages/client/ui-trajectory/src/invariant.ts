/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-trajectory`.
 * @module @njydsz/ydb-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-trajectory'
