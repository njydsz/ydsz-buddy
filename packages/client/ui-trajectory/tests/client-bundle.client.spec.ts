 ...
 * not built (`pnpm --filter @njydsz/ydb-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@njydsz/ydb-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@njydsz/ydb-client-runtime/client', await import('@njydsz/ydb-client-runtime/client')],
      ['@njydsz/ydb-client-ui-primitives', await import('@njydsz/ydb-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@njydsz/ydb-client-locale/client')
