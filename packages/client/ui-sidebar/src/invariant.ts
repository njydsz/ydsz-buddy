/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-sidebar`.
 * @module @njydsz/ydb-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-sidebar'
