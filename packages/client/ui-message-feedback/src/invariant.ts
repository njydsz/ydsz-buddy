/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-message-feedback`.
 * @module @njydsz/ydb-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-message-feedback'
