 ...
 * @module @njydsz/ydb-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@njydsz/ydb-typert-protocol'
import type { HostObservable } from '@njydsz/ydb-client-ui-slots'
import type { MessageId, SessionId } from '@njydsz/ydb-client-connection/client'
import type {
...
} from '@njydsz/ydb-message-feedback/types'
