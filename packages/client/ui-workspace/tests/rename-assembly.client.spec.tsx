...
import type { ISession, SessionId, WorkspaceId } from '@njydsz/ydb-client-runtime/client'
import type { PropsRenderSlots } from '@njydsz/ydb-client-ui-slots'
import { SlotTestRuntime, usePinnedBrowserLanguages } from '@njydsz/ydb-client-test-runtime'
import { LocaleRuntime } from '@njydsz/ydb-client-locale/client'
import { apply, inject } from '@njydsz/ydb-client-ui-workspace/client'
