/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-workspace`.
 * @module @njydsz/ydb-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-workspace'
