 ...
 * @module
 */
import { resolveWorkspacePath } from '@njydsz/ydb-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@njydsz/ydb-client-ui-primitives'
