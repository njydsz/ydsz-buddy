...
import type { SessionProviderComponent, TranslateNS } from '@njydsz/ydb-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@njydsz/ydb-client-ui-conversation/src/client/contract/slots.ts'
