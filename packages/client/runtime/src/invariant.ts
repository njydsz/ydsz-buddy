/**
 * Package-owned invariant companion for `@njydsz/ydb-client-runtime`.
 * @module @njydsz/ydb-client-runtime/invariant
 */
...
import type { SlotMap } from '@njydsz/ydb-client-ui-slots'
import type { InvariantInstaller } from '@njydsz/ydb-invariants'

const PACKAGE_NAME = '@njydsz/ydb-client-runtime'
