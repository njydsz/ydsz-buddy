/**
 * Package-owned invariant companion for `@njydsz/ydb-client-schema-form`.
 * @module @njydsz/ydb-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-schema-form'
