/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-settings-models`.
 * @module @njydsz/ydb-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-settings-models'
