/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-input-trigger`.
 * @module @njydsz/ydb-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-input-trigger'
