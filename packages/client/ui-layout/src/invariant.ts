/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-layout`.
 * @module @njydsz/ydb-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-layout'
