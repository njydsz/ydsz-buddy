/**
 * Package-owned invariant companion for `@njydsz/ydb-client-connection`.
 * @module @njydsz/ydb-client-connection/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-connection'
