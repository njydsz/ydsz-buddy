/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-deliverables`.
 * @module @njydsz/ydb-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-deliverables'
