...
import type { ChatFileMentions, TurnTailOwnerProps } from '@njydsz/ydb-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@njydsz/ydb-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@njydsz/ydb-client-ui-deliverables'])
