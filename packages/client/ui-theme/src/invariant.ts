/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-theme`.
 * @module @njydsz/ydb-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-theme'
