/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-slots`.
 * @module @njydsz/ydb-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-slots'
