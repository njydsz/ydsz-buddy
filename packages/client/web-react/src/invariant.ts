/**
 * Package-owned invariant companion for `@njydsz/ydb-client-web-react`.
 * @module @njydsz/ydb-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-web-react'
