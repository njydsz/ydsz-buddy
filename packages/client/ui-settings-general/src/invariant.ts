/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-settings-general`.
 * @module @njydsz/ydb-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-settings-general'
