/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-settings`.
 * @module @njydsz/ydb-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-settings'
