/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-permission-presets`.
 * @module @njydsz/ydb-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-permission-presets'
