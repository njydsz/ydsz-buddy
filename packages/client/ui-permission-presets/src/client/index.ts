 ...
 */
import type { ConnectionHandle } from '@njydsz/ydb-api-remotes/client'
...
import type {} from '@njydsz/ydb-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@njydsz/ydb-api-remotes/client'
import type { ClientContext, SessionFace } from '@njydsz/ydb-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@njydsz/ydb-client-ui-commands/client'
import type { ClientSessionContext } from '@njydsz/ydb-client-ui-input-trigger/client'
import type { PermissionSelect } from '@njydsz/ydb-permission-presets/client'
