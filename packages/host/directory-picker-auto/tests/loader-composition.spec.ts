...
import type { DirectoryPicker } from '@njydsz/ydb-host-directory-picker'
import BrowseDirectoryPicker from '@njydsz/ydb-host-directory-picker-browse'
import NativeDirectoryPicker from '@njydsz/ydb-host-directory-picker-native'
...
const AUTO = '@njydsz/ydb-host-directory-picker-auto'
const NATIVE = '@njydsz/ydb-host-directory-picker-native'
const BROWSE = '@njydsz/ydb-host-directory-picker-browse'
const NATIVE_SURFACE = '@njydsz/ydb-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@njydsz/ydb-client-ui-directory-picker-browse'
