 ...
 * @module @njydsz/ydb-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@njydsz/ydb-host-directory-picker-native',
  browse: '@njydsz/ydb-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@njydsz/ydb-client-ui-directory-picker-native',
  browse: '@njydsz/ydb-client-ui-directory-picker-browse',
}
