/** Package-owned invariant companion for the directory-picker seam. @module @njydsz/ydb-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@njydsz/ydb-invariants'

const PACKAGE_NAME = '@njydsz/ydb-host-directory-picker'
