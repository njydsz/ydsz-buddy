...
import type { ApprovalRequestId } from '@njydsz/ydb-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@njydsz/ydb-host-apiproxy/api'
import type { RpcId } from '@njydsz/ydb-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@njydsz/ydb-host-apiproxy/api/rpc'
