...
import type { Agent, AgentFactory } from '@njydsz/ydb-agent'
...
import { DomainFacility } from '@njydsz/ydb-storage-domain'
...
import type { DirectoryPickerCapability } from '@njydsz/ydb-host-directory-picker'
import WorkspaceRegistry from '@njydsz/ydb-workspace'
import type { HostFrame, WorkspaceId } from '@njydsz/ydb-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@njydsz/ydb-host-apiproxy/api/rpc'
