...
import type { AskUserQuestionItem } from '@njydsz/ydb-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@njydsz/ydb-user-approval/types'
import type { Message } from '@njydsz/ydb-llm/types'
import type { MessageId } from '@njydsz/ydb-llm/brand'
import type { CallId } from '@njydsz/ydb-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@njydsz/ydb-session/types'
import type { ToolCallView, ToolResultView } from '@njydsz/ydb-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@njydsz/ydb-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
