...
import LlmRuntime, { createUserMessage, CallId, ReasoningEffortId , createMessage } from '@njydsz/ydb-llm'
import type { Message, ToolSchema } from '@njydsz/ydb-llm'
import { LocalCredentialProvider } from '@njydsz/ydb-credentials-local'
import * as LlmDeepSeek from '@njydsz/ydb-llm-deepseek'
import type { Config } from '@njydsz/ydb-llm-deepseek'
...
beforeEach(async () => {
  ...
  vi.stubEnv('YDB_HOME', identityHome)
})
