 ...
 * @module @njydsz/ydb-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@njydsz/ydb-scope'
import { assertSupportedJsonSchema, defineTool } from '@njydsz/ydb-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@njydsz/ydb-cordis-client-runner`, whose CTX_VERBS names this one its
