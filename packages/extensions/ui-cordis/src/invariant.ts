/**
 * Package-owned invariant companion for `@njydsz/ydb-client-ui-cordis`.
 * @module @njydsz/ydb-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-ui-cordis'
