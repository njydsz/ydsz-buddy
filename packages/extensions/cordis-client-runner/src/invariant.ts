/**
 * Package-owned invariant companion for `@njydsz/ydb-cordis-client-runner`.
 * @module @njydsz/ydb-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-cordis-client-runner'
