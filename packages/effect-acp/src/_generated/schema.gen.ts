/**
 * @fileoverview ACP 协议 Schema 定义（自动生成）
 *
 * 定义 ACP 协议中所有消息类型的 Schema 声明和 TypeScript 类型。
 * 使用 Effect/Schema 进行运行时类型校验，同时导出对应的 TypeScript 类型。
 * 此文件由代码生成工具自动生成，请勿手动编辑。
 *
 * 所属模块：effect-acp（自动生成）
 * 主要导出：所有 ACP 协议消息类型的 Schema 及 TypeScript 类型
 *
