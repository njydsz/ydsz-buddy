/**
 * Package-owned invariant companion for `@njydsz/ydb-credentials-local`.
 * @module @njydsz/ydb-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-credentials-local'
