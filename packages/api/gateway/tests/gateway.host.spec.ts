...
import { z } from 'zod'
import { apply as applyConnection, inject as connectionInject } from '@njydsz/ydb-client-connection'
...
import TypertRegistry, { type TypertContribution } from '@njydsz/ydb-typert-registry'
import TypertGatewayService, { TypertGatewayError } from '@njydsz/ydb-api-gateway'
