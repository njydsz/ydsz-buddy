/**
 * Package-owned invariant companion for `@njydsz/ydb-workflow-worker-thread`.
 * @module @njydsz/ydb-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-workflow-worker-thread'
