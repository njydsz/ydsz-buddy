 ...
 * (`@njydsz/ydb-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @njydsz/ydb-tool-workflow
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool } from '@njydsz/ydb-tools'
import type { ToolCallView, ToolResultView } from '@njydsz/ydb-tools'
import type { ContentBlock } from '@njydsz/ydb-llm'
import type { JsonValue, Session, SessionEventMap } from '@njydsz/ydb-session'
import type {
  WorkflowResult, WorkflowRun, WorkflowRunId, WorkflowStopReason,
} from '@njydsz/ydb-workflow'
import type {
