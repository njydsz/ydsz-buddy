/**
 * Package-owned invariant companion for `@njydsz/ydb-settings-file`.
 * @module @njydsz/ydb-settings-file/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@njydsz/ydb-settings`.
 */
