...
import { createUserMessage, HarnessError } from '@njydsz/ydb-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@njydsz/ydb-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@njydsz/ydb-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@njydsz/ydb-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@njydsz/ydb-session').SessionEvent[]): StubAgent {
