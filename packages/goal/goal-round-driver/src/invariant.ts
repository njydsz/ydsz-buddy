/** Package-owned goal-round prompt invariants. @module @njydsz/ydb-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@deepseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@njydsz/ydb-goal'
...
const PACKAGE_NAME = '@njydsz/ydb-goal-round-driver'
