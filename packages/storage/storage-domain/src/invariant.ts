/**
 * Package-owned invariant companion for `@njydsz/ydb-storage-domain`: every
 ...
 * @module @njydsz/ydb-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-storage-domain'
