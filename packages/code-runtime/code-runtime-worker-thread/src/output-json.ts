/** JSON string-prefix accounting for the outer-output ledger. @module @njydsz/ydb-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@njydsz/ydb-code-runtime'
