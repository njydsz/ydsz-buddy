/**
 * Package-owned invariant companion for `@njydsz/ydb-code-runtime-worker-thread`.
 * @module @njydsz/ydb-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-code-runtime-worker-thread'
