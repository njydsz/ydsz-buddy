 ...
 * @module @njydsz/ydb-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@njydsz/ydb-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@njydsz/ydb-*` row would fail to import. The
