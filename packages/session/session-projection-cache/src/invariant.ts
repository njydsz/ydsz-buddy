/**
 * Package-owned invariant companion for `@njydsz/ydb-session-projection-cache`.
 * @module @njydsz/ydb-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-projection-cache'
