/**
 * Package-owned invariant companion for `@njydsz/ydb-session-title-first-prompt-llm`.
 * @module @njydsz/ydb-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-title-first-prompt-llm'
