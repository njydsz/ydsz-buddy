/**
 * Package-owned invariant companion for `@njydsz/ydb-session-title-all-prompts-llm`.
 * @module @njydsz/ydb-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-title-all-prompts-llm'
