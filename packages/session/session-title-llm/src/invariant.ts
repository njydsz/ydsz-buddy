/**
 * Package-owned invariant companion for `@njydsz/ydb-session-title-llm`.
 * @module @njydsz/ydb-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-title-llm'
