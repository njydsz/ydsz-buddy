/**
 * Package-owned invariant companion for `@njydsz/ydb-session-checkpoint-policy`.
 * @module @njydsz/ydb-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-checkpoint-policy'
