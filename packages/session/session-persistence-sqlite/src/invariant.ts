/**
 * Package-owned invariant companion for `@njydsz/ydb-session-persistence-sqlite`.
 * @module @njydsz/ydb-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-persistence-sqlite'
