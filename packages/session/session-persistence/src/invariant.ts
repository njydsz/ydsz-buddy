/**
 * Package-owned invariant companion for `@njydsz/ydb-session-persistence`.
 * @module @njydsz/ydb-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-persistence'
