/**
 * Package-owned invariant companion for `@njydsz/ydb-session-projection`.
 * @module @njydsz/ydb-session-projection/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-projection'
