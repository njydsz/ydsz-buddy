 ...
 *
 * @module @njydsz/ydb-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@njydsz/ydb-command-feedback'
import {
...
} from '@njydsz/ydb-session-telemetry'
import { APP_IDENTITY } from '@njydsz/ydb-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@njydsz/ydb-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@njydsz/ydb-session-telemetry-otel/ops', version)
