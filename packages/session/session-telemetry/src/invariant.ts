/**
 * Package-owned invariant companion for `@njydsz/ydb-session-telemetry`.
 * @module @njydsz/ydb-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-telemetry'
