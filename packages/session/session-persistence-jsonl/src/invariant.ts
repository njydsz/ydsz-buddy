/**
 * Package-owned invariant companion for `@njydsz/ydb-session-persistence-jsonl`.
 * @module @njydsz/ydb-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-persistence-jsonl'
