/**
 * Package-owned invariant companion for `@njydsz/ydb-anonymous-user-id`.
 * @module @njydsz/ydb-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-anonymous-user-id'
