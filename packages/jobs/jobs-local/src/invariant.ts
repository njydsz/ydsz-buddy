/**
 * Package-owned invariant companion for `@njydsz/ydb-jobs-local`.
 * @module @njydsz/ydb-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-jobs-local'
...
/**
 * No runtime invariant: `@njydsz/ydb-jobs/invariant` owns per-snapshot identity, status,
