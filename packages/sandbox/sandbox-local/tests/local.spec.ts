...
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@njydsz/ydb-sandbox'
import type { SandboxPolicy } from '@njydsz/ydb-sandbox'
import {
  LocalSandboxProvider,
} from '@njydsz/ydb-sandbox-local'
import type { Config } from '@njydsz/ydb-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @njydsz/ydb-sandbox-windows-acl/tests/provider-chain.spec.ts
