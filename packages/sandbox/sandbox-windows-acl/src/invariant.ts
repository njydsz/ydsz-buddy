/**
 * Package-owned invariant companion for `@njydsz/ydb-sandbox-windows-acl`.
 * @module @njydsz/ydb-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-sandbox-windows-acl'
