/**
 * Package-owned invariant companion for `@njydsz/ydb-output-retention`.
 * @module @njydsz/ydb-output-retention/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-output-retention'
