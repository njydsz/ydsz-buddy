/**
 * `@njydsz/ydb-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@njydsz/ydb-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@njydsz/ydb-web`.
 *
 * @module @njydsz/ydb-web-search-exa
 */

import type { Context } from '@deepseek-ai/cordis'
import { launchEnvironmentOf } from '@njydsz/ydb-launch-environment'
import z from '@deepseek-ai/schemastery'
import type {} from '@njydsz/ydb-web'
import {
  ExaSearchProvider,
