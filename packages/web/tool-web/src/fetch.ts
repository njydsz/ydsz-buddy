...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@njydsz/ydb-tools'
import type { WebFetchBody, WebFetchResult } from '@njydsz/ydb-web'
 ...
 * `@njydsz/ydb-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@njydsz/ydb-tool-call-timeout-policy` to enforce.
