 ...
 * `@njydsz/ydb-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @njydsz/ydb-web-fetch-http/provider
 */

import { WebError } from '@njydsz/ydb-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@njydsz/ydb-web'
