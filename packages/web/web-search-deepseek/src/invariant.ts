/**
 * Package-owned invariant companion for `@njydsz/ydb-web-search-deepseek`.
 * @module @njydsz/ydb-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-web-search-deepseek'
