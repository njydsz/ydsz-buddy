/**
 * Package-owned invariant companion for `@njydsz/ydb-sdk-jsonrpc-demo`.
 * @module @njydsz/ydb-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-sdk-jsonrpc-demo'
