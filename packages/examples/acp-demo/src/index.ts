 ...
 * ({@link @njydsz/ydb-agent-spine-demo}), JSONL session persistence, and
 * the {@link @njydsz/ydb-acp} bridge. The app owns those plugins through one
 ...
 * @module @njydsz/ydb-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@njydsz/ydb-acp'
import * as agentCore from '@njydsz/ydb-agent-spine-demo'
...
} from '@njydsz/ydb-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@njydsz/ydb-session-checkpoint-policy'
