 ...
 * @module @njydsz/ydb-agent-spine-demo
 */
...
import SessionTitleService, { type Config as SessionTitleConfig } from '@njydsz/ydb-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@njydsz/ydb-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@njydsz/ydb-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@njydsz/ydb-skill'
import * as SkillFileSystem from '@njydsz/ydb-skill-filesystem'
import AgentRegistry from '@njydsz/ydb-agent'
import GoalService, { type Config as GoalDomainConfig } from '@njydsz/ydb-goal'
import * as goalSession from '@njydsz/ydb-goal-round-driver'
import * as toolGoal from '@njydsz/ydb-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@njydsz/ydb-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@njydsz/ydb-invariants'
...
import * as bashEnv from '@njydsz/ydb-shell-env'
