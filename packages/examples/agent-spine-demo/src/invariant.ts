/**
 * Package-owned invariant companion for `@njydsz/ydb-agent-spine-demo`.
 * @module @njydsz/ydb-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-agent-spine-demo'
