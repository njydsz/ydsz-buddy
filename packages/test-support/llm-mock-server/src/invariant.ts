/**
 * Package-owned invariant companion for `@njydsz/ydb-llm-mock-server`.
 * @module @njydsz/ydb-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-llm-mock-server'
