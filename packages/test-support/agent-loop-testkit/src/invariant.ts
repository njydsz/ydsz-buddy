/**
 * Package-owned invariant companion for `@njydsz/ydb-agent-loop-testkit`.
 * @module @njydsz/ydb-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-agent-loop-testkit'
