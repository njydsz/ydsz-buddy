/**
 * Package-owned invariant companion for `@njydsz/ydb-client-test-runtime`.
 * @module @njydsz/ydb-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-client-test-runtime'
