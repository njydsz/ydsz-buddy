...
import type { AttachmentIdType } from '@njydsz/ydb-attachment'
import { createScope, scopeOf, SessionProvideChannel } from '@njydsz/ydb-client-runtime/client'
...
import { SESSION_SEARCH_RESULT_LIMIT } from '@njydsz/ydb-host-apiproxy/api'
import type { HostObservable, SessionMaybeProvideInfo, SessionProvideInfo } from '@njydsz/ydb-client-ui-slots'
