/**
 * Package-owned invariant companion for `@njydsz/ydb-session-query-sqlite`.
 * @module @njydsz/ydb-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-query-sqlite'
