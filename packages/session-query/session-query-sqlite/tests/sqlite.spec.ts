import { createAssistantMessage, createUserMessage } from '@njydsz/ydb-llm'
...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@njydsz/ydb-session'
import type { SessionEvent, SessionHeader, SessionId as SessionIdType } from '@njydsz/ydb-session'
import SessionPersistence, { SessionPersistenceRevision } from '@njydsz/ydb-session-persistence'
import type { SessionPersistenceSnapshot } from '@njydsz/ydb-session-persistence'
import SqliteSessionPersistence from '@njydsz/ydb-session-persistence-sqlite'
import SqliteSessionQueryEngine, {
  SESSION_QUERY_SQLITE_SCHEMA_VERSION,
} from '@njydsz/ydb-session-query-sqlite'
import {
