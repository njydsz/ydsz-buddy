/**
 * Package-owned invariant companion for `@njydsz/ydb-tool-session-query`.
 * @module @njydsz/ydb-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-tool-session-query'
