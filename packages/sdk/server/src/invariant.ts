/**
 * Package-owned invariant companion for `@njydsz/ydb-sdk-jsonrpc-server`.
 * @module @njydsz/ydb-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-sdk-jsonrpc-server'
