 ...
 * model-facing render consumes ({@link module:@njydsz/ydb-tool-fs-search/search-core}
 ...
 *
 * @module @njydsz/ydb-tool-fs-search/presentation
 */
 ...
 * ({@link module:@njydsz/ydb-tool-fs-search/grep} `formatGrepMatches`), so
