 ...
 *
 * @module @njydsz/ydb-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@njydsz/ydb-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@njydsz/ydb-tools'
import type { RetainedItems } from '@njydsz/ydb-output-retention'
import type { SpillRef } from '@njydsz/ydb-spill'
