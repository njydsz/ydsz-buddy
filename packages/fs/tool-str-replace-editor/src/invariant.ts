/**
 * Package-owned invariant companion for `@njydsz/ydb-tool-str-replace-editor`.
 * @module @njydsz/ydb-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-tool-str-replace-editor'
