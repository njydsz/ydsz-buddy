/**
 * Package-owned invariant companion for `@njydsz/ydb-typert-generator`.
 * @module @njydsz/ydb-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-typert-generator'
