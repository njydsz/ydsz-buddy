/**
 * Package-owned invariant companion for `@njydsz/ydb-typert-registry`.
 * @module @njydsz/ydb-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-typert-registry'
