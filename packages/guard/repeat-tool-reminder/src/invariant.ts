/**
 * Package-owned invariant companion for `@njydsz/ydb-repeat-tool-reminder`.
 * @module @njydsz/ydb-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-repeat-tool-reminder'
