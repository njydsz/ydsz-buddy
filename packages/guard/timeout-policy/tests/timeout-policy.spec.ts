/**
 * Unit + real-load-path coverage for @njydsz/ydb-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@njydsz/ydb-llm'
import SystemPrompt from '@njydsz/ydb-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@njydsz/ydb-tools'
import * as timeoutPolicy from '@njydsz/ydb-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@njydsz/ydb-tool-call-timeout-policy'
