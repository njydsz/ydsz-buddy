/** Package-owned scoped-dispatch invariants. @module @njydsz/ydb-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@njydsz/ydb-invariants'
import { carrierKeyOf, isScopeCarrier } from '@njydsz/ydb-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@njydsz/ydb-scope'
