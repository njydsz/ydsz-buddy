...
import { bindScopeParent, carrierKeyOf, createScope, isScopeCarrier, scopeChainOf, scopeOf, scopeParentOf, scopeTarget } from '@njydsz/ydb-scope'
import type { Scope, Scoped } from '@njydsz/ydb-scope'
