...
import { createScope, scopeOf } from '@njydsz/ydb-scope'
import type { Scope, ScopeKey } from '@njydsz/ydb-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@njydsz/ydb-system-prompt'
import type { Config, PromptAssembly } from '@njydsz/ydb-system-prompt'
