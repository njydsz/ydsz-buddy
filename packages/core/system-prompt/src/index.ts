 ...
 *
 * @module @njydsz/ydb-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@njydsz/ydb-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@njydsz/ydb-scope'
import type { ContextSnapshotSection, ToolSchema } from '@njydsz/ydb-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@njydsz/ydb-scope`): scoped listeners
