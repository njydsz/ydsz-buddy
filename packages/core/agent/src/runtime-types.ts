 ...
 * turn/step boundaries remain `@njydsz/ydb-session` events.
 *
 * @module @njydsz/ydb-agent
 */

import type { Context } from '@deepseek-ai/cordis'
import type { Scoped } from '@njydsz/ydb-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@njydsz/ydb-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@njydsz/ydb-session'
export type { AgentCancelCause } from '@njydsz/ydb-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@njydsz/ydb-system-prompt'
declare module '@njydsz/ydb-system-prompt' {
...
declare module '@deepseek-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@njydsz/ydb-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
