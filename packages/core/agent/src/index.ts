...
import type { TypertContext, TypertLookup } from '@njydsz/ydb-typert-protocol'
 ...
 * (`@njydsz/ydb-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@njydsz/ydb-agent#Agent',
