/**
 * Package-owned invariant companion for `@njydsz/ydb-tool-subagent-report`.
 * @module @njydsz/ydb-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-tool-subagent-report'
