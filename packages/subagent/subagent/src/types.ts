 ...
 *
 * @module @njydsz/ydb-subagent/types
 */

import type { Agent, AgentOptions } from '@njydsz/ydb-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@njydsz/ydb-tools'
