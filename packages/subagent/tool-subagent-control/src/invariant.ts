/**
 * Package-owned invariant companion for `@njydsz/ydb-tool-subagent-control`.
 * @module @njydsz/ydb-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-tool-subagent-control'
