/**
 * Package-owned invariant companion for `@njydsz/ydb-subagent-dsh-sdk`.
 * @module @njydsz/ydb-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-subagent-dsh-sdk'
