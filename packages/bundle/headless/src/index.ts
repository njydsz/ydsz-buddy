/**
 * @njydsz/ydb-headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@njydsz/ydb-agent'
import type {} from '@njydsz/ydb-agent-default-model'
...
import type {} from '@njydsz/ydb-cmdline'
...
async function run(ctx: Context, task: string, io: HeadlessIo): Promise<void> {
  ...
  // (@njydsz/ydb-agent-presets README, "Composing a child agent").
