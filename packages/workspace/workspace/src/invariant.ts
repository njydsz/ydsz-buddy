/**
 * Package-owned invariant companion for `@njydsz/ydb-workspace`.
 * @module @njydsz/ydb-workspace/invariant
 */
...
import { WorkspaceId } from '@njydsz/ydb-workspace'

const PACKAGE_NAME = '@njydsz/ydb-workspace'
