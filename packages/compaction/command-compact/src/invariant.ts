/**
 * Package-owned invariant companion for `@njydsz/ydb-command-compact`.
 * @module @njydsz/ydb-command-compact/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-command-compact'
