 ...
 *
 * The seam itself lives in `@njydsz/ydb-compaction`, which re-exports these
 ...
 *
 * @module @njydsz/ydb-compaction/checkpoint
 */

import type { MessageSource } from '@njydsz/ydb-llm/message'
