/**
 * Package-owned invariant companion for `@njydsz/ydb-compaction-tool-result-pruner`.
 * @module @njydsz/ydb-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-compaction-tool-result-pruner'
