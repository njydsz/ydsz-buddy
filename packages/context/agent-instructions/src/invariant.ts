/**
 * Package-owned invariant companion for `@njydsz/ydb-agent-instructions`.
 * @module @njydsz/ydb-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-agent-instructions'
