/**
 * Package-owned invariant companion for `@njydsz/ydb-session-reference`.
 * @module @njydsz/ydb-session-reference/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-session-reference'
