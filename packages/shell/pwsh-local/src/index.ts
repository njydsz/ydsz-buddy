...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@njydsz/ydb-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@njydsz/ydb-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@njydsz/ydb-subprocess'
import { installSettingsSection } from '@njydsz/ydb-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@njydsz/ydb-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@njydsz/ydb-pwsh-sandbox`.
