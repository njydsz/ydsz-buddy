/**
 * Real-process tests for `@njydsz/ydb-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@njydsz/ydb-pwsh-local'
import LocalSubprocessRuntime from '@njydsz/ydb-subprocess-local'
import SubprocessRuntime from '@njydsz/ydb-subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@njydsz/ydb-subprocess'
import { MAX_TIMER_DELAY_MS } from '@njydsz/ydb-timeout'
import type { ShellProcess } from '@njydsz/ydb-shell'
