/**
 * Package-owned invariant companion for `@njydsz/ydb-tool-bash-persistent`.
 * @module @njydsz/ydb-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-tool-bash-persistent'
