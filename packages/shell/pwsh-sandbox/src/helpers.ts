 ...
 * mirror of `@njydsz/ydb-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @njydsz/ydb-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@njydsz/ydb-shell'
import type { RunnerFailureRule } from '@njydsz/ydb-sandbox'
