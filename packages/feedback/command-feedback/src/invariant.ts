/**
 * Package-owned invariant companion for `@njydsz/ydb-command-feedback`.
 * @module @njydsz/ydb-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@njydsz/ydb-command-feedback'
