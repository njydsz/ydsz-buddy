...
import type { Agent, AgentStatus } from '@njydsz/ydb-agent'
import CommandRuntime from '@njydsz/ydb-commands'
import SessionStore, { foldSurface, Session, SessionId } from '@njydsz/ydb-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@njydsz/ydb-session-telemetry'
import * as commandFeedback from '@njydsz/ydb-command-feedback'
...
vi.mock('@njydsz/ydb-anonymous-user-id', () => ({
...
describe('@njydsz/ydb-command-feedback registration', () => {
