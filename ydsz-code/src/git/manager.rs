...
//! ### 线程（Thread）
//!
//! 在 ydsz 工作区中，'线程'指的是一个独立的工作上下文，通常对应一个 Git worktree。
...
//! async fn main() {
//! use std::sync::Arc;
//! use ydsz_git::{GitCore, GitManager, GitRunStackedActionInput, GitAction};
//! 
...
use super::core::{GitCore, GitStatusResult};
...
///
///```rust,ignore
/// use ydsz_git::{GitRunStackedActionInput, GitAction};
///
...
/// async fn main() {
/// use std::sync::Arc;
/// use ydsz_git::{GitCore, GitManager};
/// 
/// let core = Arc::new(GitCore::new());
/// let manager = GitManager::new(core);
/// 
