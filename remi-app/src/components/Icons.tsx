/**
 * @file Icons.tsx
 * @description 应用内共享的 SVG 图标组件集合，包括各 AI 提供商标识图标
 *              （OpenAI、Claude、Gemini、Grok 等）以及通用 UI 图标（拖拽手柄、
 *              GitHub、VS Code、Zed 等）。所有图标均遵循统一的 Icon 类型签名。
 */
import { type SVGProps, useId } from "react";
import { SiAnthropic } from "react-icons/si";

/** SVG 图标组件的统一类型，接受标准 SVG 属性 */
