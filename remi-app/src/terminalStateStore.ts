...
import { type TerminalActivityState, type TerminalCliKind } from "@remi-claw/shared/terminalThreads";
...
const TERMINAL_STATE_STORAGE_KEY = "remi-claw:terminal-state:v1";
