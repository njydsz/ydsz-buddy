...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
    ...
    features: [
      {
        ...
        description: "Remi Claw now includes Claude Opus 4.8 in the Claude model picker.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The provider picker no longer treats unknown provider status as usable. Providers stay in a checking state until Remi Claw has confirmed that the local runtime is available and authenticated.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Remi Claw can now launch and monitor Kilo Code sessions alongside Codex, Claude, Cursor, OpenCode, and Gemini, with health checks, settings, mentions, handoff, and model compatibility wired through the app.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Remi Claw now tracks the newer OpenCode SDK session events, keeps titles fresher, and has much deeper coverage around OpenCode startup, output, and recovery flows.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Remi Claw now serves generated files through a dedicated local-image endpoint with MIME checks, workspace-aware path resolution, and Codex generated_images allowlists for both the normal home and desktop overlay home.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "cursor-provider",
        title: "Cursor is now a first-class Remi Claw provider",
        description:
          "Run Cursor CLI sessions directly from Remi Claw with ACP-backed startup, model discovery, existing-chat resume, handoff, and provider health checks alongside Codex and OpenCode.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git actions menu can now commit current work and push it from Remi Claw, keeping the common release and handoff flow closer to the chat.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git menu now includes branch creation with Remi Claw-style names, and PR creation can recover from GitHub duplicate-PR responses by reusing the existing open pull request.",
      },
      {
        id: "legacy-import-recovery",
        title: "Legacy T3 imports heal themselves",
        description:
          "A new migration reconciles older imported T3 Code databases whose migration history skipped Remi Claw schema changes, preventing missing-column crashes after import.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "OpenCode todo events now flow into Remi Claw as active task updates, with a compact banner option for keeping current work visible without taking over the chat.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode sessions now report context usage more consistently, giving Remi Claw better runtime visibility as conversations grow.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Cursor is now available as a provider, with ACP sessions, model discovery, existing chats, handoff, shortcuts, and git text generation wired into Remi Claw.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Toast notifications picked up feature-flag wiring, giving Remi Claw a safer way to roll notification changes forward or back.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Remi Claw now handles messy branch switches with clearer recovery actions, recreated stashes, unpublished branch publishing, and stronger checks around conflicts and local work.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The desktop app now has app-level back and forward navigation controls, making it easier to move around Remi Claw without losing your place.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "GPT-5.5 is now in the model picker with the right default reasoning behavior, so you can move new Codex sessions onto the latest model directly from Remi Claw.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Remi Claw now shows a proper splash screen while the desktop backend spins up, so launch feels intentional instead of looking briefly stalled.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "The new theme pack editor lets you tune UI colors directly in Remi Claw, with shared theme tokens keeping the sidebar, composer, transcript, and controls in sync.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "If the updater never answers, Remi Claw now times out and recovers instead of hanging on a permanent Checking status.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Point Remi Claw at your own Codex, Claude, or Gemini binary when your setup lives outside the default install path.",
      },
      {
