...
// Purpose: Render a single "What's new" feature card 鈥?title, description,
...
// Layer: presentational 鈥?no state, no data fetching, no storage.
 ...
 *     muted blurb 鈥?think "release note footnote", not body copy.
 */
