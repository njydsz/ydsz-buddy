 ...
 */
export const WORKTREE_BRANCH_PREFIX = "peakcode";
...
/** @deprecated Alias for remi-code compatibility */
export const resolveUniqueRemicodeBranchName = resolveUniquePeakcodeBranchName;
