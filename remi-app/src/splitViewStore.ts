...
import { type ProjectId, type ThreadId, type TurnId } from "@remi-claw/contracts";
...
// Keep the v1 suffix stable while using the Remi Claw namespace.
const SPLIT_VIEW_STORAGE_KEY = "remi-claw:split-view-state:v1";
