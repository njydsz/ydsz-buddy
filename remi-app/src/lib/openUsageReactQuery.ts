 ...
 * @description OpenUsage 服务的 React Query 查询配置，通过轮询本地 HTTP 端点获取
...
/** localStorage 中控制 OpenUsage 轮询开关的键名 */
const OPEN_USAGE_ENABLED_STORAGE_KEY = "remicode.openUsage.enabled";

/** 检查 OpenUsage 轮询是否已通过 localStorage 启用 */
 ...
 * @returns React Query queryOptions 配置对象，包含 15 秒轮询间隔
 *
 * @example
 * ```ts
