...
//             and @remi-claw/shared/localImage for the canonical route + extension allowlist.

import {
  LOCAL_IMAGE_ROUTE_PATH,
  SUPPORTED_LOCAL_IMAGE_EXTENSION_REGEX,
} from "@remi-claw/shared/localImage";
import { isWindowsAbsolutePath } from "@remi-claw/shared/path";
