...
import type { CordisCatalogModel, ServiceMethodEntry } from '@njydsz/ydb-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@njydsz/ydb-tool-cordis/api-catalog', '@njydsz/ydb-cordis-client-runner/client/api-catalog')
